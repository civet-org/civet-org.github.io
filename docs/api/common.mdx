...
| modifyRequest | `(url: URL, request: RequestInit & { search: URLSearchParams \| string \| string[][] \| Record<string, string> }, meta: Meta) => Promise<void>`                             | Function for customizing requests, for example for adding authentication details              |
| getResponse   | `(url: URL, request: RequestInit & { search: URLSearchParams \| string \| string[][] \| Record<string, string> }, response: Response, meta: Meta) => Promise<any \| any[]>` | Function for customizing how to resolve the response                                          |
| handleError   | `(url: URL, request: RequestInit & { search: URLSearchParams \| string \| string[][] \| Record<string, string> }, response: Response, meta: Meta) => Promise<any \| any[]>` | Function for customizing error handling                                                       |

### Class members

| Name      |  Arguments                                                                                                                                                                                                                                |  Return Type            | Description                                             |
| --------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------- | ------------------------------------------------------- |
| handleGet | url: `string`, query: `RequestInit & { search: URLSearchParams \| string \| string[][] \| Record<string, string> }`, options: [`FetchOptions`](#fetch-options), meta: [`Meta`](core#meta), abortSignal: [`AbortSignal`](core#abortsignal) | `Promise<any \| any[]>` |                                                         |
| request   | url: `string`, query: `RequestInit & { search: URLSearchParams \| string \| string[][] \| Record<string, string> }`, options: [`FetchOptions`](#fetch-options), meta: [`Meta`](core#meta), abortSignal: [`AbortSignal`](core#abortsignal) | `Promise<any \| any[]>` | Performs the specified request and returns the response |
...
| getResponse | `(url: URL, request: RequestInit & { search: URLSearchParams \| string \| string[][] \| Record<string, string> }, response: Response, meta: Meta) => Promise<any \| any[]>` | Function for customizing how to resolve the response (takes priority over [`fetch provider options`](#fetch-provider-options)) |
| handleError | `(url: URL, request: RequestInit & { search: URLSearchParams \| string \| string[][] \| Record<string, string> }, response: Response, meta: Meta) => Promise<any \| any[]>` | Function for customizing error handling (takes priority over [`fetch provider options`](#fetch-provider-options))              |
...
| Name            |  Arguments                                                                                           |  Return Type | Description                                                                             |
| --------------- | ---------------------------------------------------------------------------------------------------- | ------------ | --------------------------------------------------------------------------------------- |
| setEventSource  | eventSource: `EventSource`                                                                           | `void`       | [EventSource](https://developer.mozilla.org/en-US/docs/Web/API/EventSource) to be used  |
