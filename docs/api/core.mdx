...
| extend          | `{ resource: (resourcePlugin: ReactComponent) => void }`                                                                                                                                                                   | `void`                    | Extend Civet with custom functionality (see [Extending Civet](/docs/guides/extending#datastore) for more details)       |
