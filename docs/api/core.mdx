...
| ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| get                 | resourceName: `string`, query: `any`, options: `object`, meta: `object` &#124; [`Meta`](#meta), abortSignal: [`AbortSignal`](#abortsignal)                                                                   | `Promise<any[]>`          | Get data (at once &#124; uses `handleGet` internally)                                                                                                                                                                   |
...
| Name         | Arguments                                                                                                                  | Return Type                                                                                                       | Description                                                                                   |
| ------------ | -------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- |
| handleGet    | resourceName: `string`, query: `any`, options: `object`, meta: [`Meta`](#meta), abortSignal: [`AbortSignal`](#abortsignal) | `any[]` &#124; `Promise<any[]>` &#124; `(callback: (error: any, complete: boolean, data: any[]) => void) => void` | A callback function can be returned to support continuous gets (see caveats for more details) |
