...
| isDisabled   | `boolean`                                              | Whether fetching data is disabled, resulting in an empty response                                  |
...
| query        | `any`                           | Query instructions                                                                                                                 |
| options      | `object`                        | Query options for requests                                                                                                         |
| disabled     | `boolean`                       | Disables fetching data, resulting in an empty response                                                                             |
...
| extend              | extend: `{ context: (contextPlugin: ReactHook) => void, ui: (uiPlugin: ReactComponent) => void }`                                                                                                                   | `void`                    | Extend Civet with custom functionality (see [Extending Civet](../guides/extending#dataprovider) for more details)                                                                                                       |
...
| releaseInstance     | instance: `any`                                                                                                                                                                                                     | `void`                    | Used to release an instance element previously created with `createInstance`                                                                                                                                            |
| normalizeResource   | resourceName: `string`                                                                                                                                                                                              | `string`                  | Used to normalize resource names                                                                                                                                                                                        |
| createEmptyResponse | requestDetails: `object`                                                                                                                                                                                            | `any \| any[]`            | Creates an empty response to be used where no actual data is available                                                                                                                                                  |
...
The methods `get` and `continuousGet` internally invoke the abstract method `handleGet` and perform generic validation on their parameters and return values. Therefore, you should not override them, but implement the abstract `handleGet` method instead.
...
| once         | handler: `(...args: any) => void` | unsubscribe: `() => void` | Subscribe and automatically unsubscribe after receiving a single notification |
...
| once         | handler: `(channel: string, ...args: any) => void` | unsubscribe: `() => void` | Subscribe and automatically unsubscribe after receiving a single notification on the specified channel                              |
