...
| extend              | `{ context: (contextPlugin: ReactHook) => void, ui: (uiPlugin: ReactComponent) => void }`                                                                                                                    | `void`                    | Extend Civet with custom functionality (see [Extending Civet](/docs/guides/extending#dataprovider) for more details)                                                                                                    |
...
See [Extending Civet](/docs/guides/extending#dataprovider-plugins) for further details.
